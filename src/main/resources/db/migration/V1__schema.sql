...
create table movie_content_list (id bigint generated by default as identity, name varchar(255), user_id bigint, primary key (id));
...
alter table movie_content_list add constraint FKr0w2mro75ioydyxenff9sj69l foreign key (user_id) references users;
